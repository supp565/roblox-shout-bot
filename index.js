// Remove global-agent to stop header manipulation
...
async function startBot() {
    try {
        console.log("Initializing bot session via API routing...");
        
        // Define your active cookie string cleanly
        ...
        // Log in first to grab the baseline data
        await noblox.setCookie(cookie);
        
        // Manually fetch player info to verify authentication status bypasses proxy metadata drop
