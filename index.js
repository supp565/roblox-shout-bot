...
async function startBot() {
    try {
        ...
        // Route all noblox requests through an API proxy mirror
        // This removes the code: 0 blocks automatically
        noblox.setOptions({
            show_deprecation_warnings: false,
            apiGroup: "://roproxy.com"
        });
        
        await noblox.setCookie(cookie);
        console.log("Logged in successfully. Sending shout via RoProxy wrapper...");
